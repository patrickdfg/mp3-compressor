...
[**MP3 가볍게 웹사이트 열기**](https://patrickdfg.github.io/mp3-compressor/)
...
파일당 최대 **200MB / 3시간**, 출력 샘플레이트 **24kHz**입니다. 브라우저 메모리를 사용하므로 긴 파일은 PC에서 사용하는 것이 좋습니다. 새로고침하거나 탭을 닫으면 목록과 결과가 사라집니다. 스테레오를 선택해도 원본이 모노이면 모노를 유지합니다.
